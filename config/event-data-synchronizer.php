...
return [
    ...
    'maropost_contact_type' => [
        'pianote' => 'pianote_user_id',
        'recordeo' => 'recordeo_user_id',
        'guitareo' => 'guitareo_user_id',
        'drumeo' => 'drumeo_user_id',
    ],
    'maropost_member_active_tag' => [
        'pianote' => 'Pianote - Customer - Member - Active',
        'recordeo' => 'Recordeo - Customer - Member - Active',
    ...
    'maropost_member_expired_tag' => [
        ...
        'recordeo' => 'Recordeo - Customer - Member - ExMember',
